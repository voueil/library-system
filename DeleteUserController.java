...
public class DeleteUserController implements Initializable {
    ...
    private void deleteBook(ActionEvent event) {
        boolean rowsAffected = handler.deleteUser(tfID.getText());

            if (rowsAffected) {
                successText.setText("User Deleted Successfully!");
                tfID.clear();
            } else {
                successText.setText("No user found with the provided ISBN.");
            }
    }
