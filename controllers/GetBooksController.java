...
public class GetBooksController implements Initializable {
    ...
    private void handleNavigation(ActionEvent event) throws IOException {
        ...
        if (source == btnBack) {
            ...
            root = FXMLLoader.load(getClass().getResource("/views/AddBook.fxml"));
        } else if (source == btnEdit) {
            root = FXMLLoader.load(getClass().getResource("/views/EditBook.fxml"));
        } else if (source == btnDelete) {
            root = FXMLLoader.load(getClass().getResource("/views/DeleteBook.fxml"));
        }
